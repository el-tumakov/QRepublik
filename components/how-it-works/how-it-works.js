      ...
      <ul className={styles.list}>
        <li className={styles.signUp}>
          ...
          <p className={styles.description}>
            Войдите, если у вас уже есть профиль на QRepublik, или создайте
            новый аккаунт, если нет. Вы можете использовать для этого свой
            e-mail, телефон или соцсеть.
          </p>
        </li>
        ...
        <li className={styles.familyProfile}>
          ...
          <p className={styles.description}>
            Добавьте членов вашей семьи и управляйте их профилями со своего
            аккаунта.
          </p>
        </li>
        <li className={styles.data}>
          ...
          <p className={styles.description}>
            ...
            удаляйте данные в любое время. Сохранённая информация отображается
            при сканировании вашего QR кода.
          </p>
        </li>
      </ul>
    </div>
